...
version_0 = VERSION_0(
    schema.tables.StockDaily,
    {
        ...
        '融券限額': schema.tables.StockDaily.f_short_limit.融券_次日限額_股數,
        '借券賣出': schema.tables.StockDaily.f_sbl_flow_volume.借券賣出_賣出_股數,
        '借券庫存異動': schema.tables.StockDaily.f_sbl_flow_volume.借券賣出_不含賣出_總異動_股數,
        '借券今日餘額': schema.tables.StockDaily.f_sbl_balance_volume.借券賣出_餘額_股數,
        '借券可使用額度': schema.tables.StockDaily.f_sbl_limit.借券賣出_次日限額_股數
    },
    True
)
...
version_1 = VERSION_1(
    schema.tables.StockDaily,
    {
        ...
        '融券今日餘額': schema.tables.StockDaily.f_short_balance_volume.融券_餘額_股數,
        '融券限額': schema.tables.StockDaily.f_short_limit.融券_次日限額_股數,
        '借券當日賣出': schema.tables.StockDaily.f_sbl_flow_volume.借券賣出_賣出_股數,
        '借券當日還券': schema.tables.StockDaily.f_sbl_flow_volume.借券賣出_還券_股數,
        '借券當日調整數額': schema.tables.StockDaily.f_sbl_flow_volume.借券賣出_調整_股數,
        '借券當日餘額': schema.tables.StockDaily.f_sbl_balance_volume.借券賣出_餘額_股數,
        '今日可借券賣出限額': schema.tables.StockDaily.f_sbl_limit.借券賣出_次日限額_股數
    },
    True
)
...
version_2 = VERSION_2(
    schema.tables.StockDaily,
    {
        ...
        '融券買進': schema.tables.StockDaily.f_short_flow_volume.融券_買進_股數,
        '融券現券': schema.tables.StockDaily.f_short_flow_volume.融券_現償_股數,
        '融券當日餘額': schema.tables.StockDaily.f_short_balance_volume.融券_餘額_股數,
        '融券限額': schema.tables.StockDaily.f_short_limit.融券_次日限額_股數,
        ...
        '借券賣出當日調整數額': schema.tables.StockDaily.f_sbl_flow_volume.借券賣出_調整_股數,
        '借券賣出當日餘額': schema.tables.StockDaily.f_sbl_balance_volume.借券賣出_餘額_股數,
        '借券賣出次一營業日可借券賣出限額': schema.tables.StockDaily.f_sbl_limit.借券賣出_次日限額_股數
    },
    True
)