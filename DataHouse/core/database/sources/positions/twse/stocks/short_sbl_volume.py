...
version_0 = VERSION_0(
    StockDaily,
    {
        ...
        '融券次一營業日限額': StockDaily.f_short_limit.融券_次日限額_股數,
        '借券賣出賣出': StockDaily.f_sbl_flow_volume.借券賣出_賣出_股數,
        '借券賣出庫存異動': StockDaily.f_sbl_flow_volume.借券賣出_不含賣出_總異動_股數,
        '借券賣出今日餘額': StockDaily.f_sbl_balance_volume.借券賣出_餘額_股數,
        '借券賣出可使用額度': StockDaily.f_sbl_limit.借券賣出_次日限額_股數
    },
    True
)
...
version_1 = VERSION_1(
    StockDaily,
    {
        ...
        '借券賣出當日調整': StockDaily.f_sbl_flow_volume.借券賣出_調整_股數,
        '借券賣出當日餘額': StockDaily.f_sbl_balance_volume.借券賣出_餘額_股數,
        '借券賣出次一營業日可限額': StockDaily.f_sbl_limit.借券賣出_次日限額_股數
    },
    True
)