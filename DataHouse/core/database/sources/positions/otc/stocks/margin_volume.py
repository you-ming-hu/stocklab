...
version_0 = VERSION_0(
    StockDaily,
    {
        ...
        '現金償還': StockDaily.f_margin_flow_volume.融資_現償_股數,
        '本日融資餘額': StockDaily.f_margin_balance_volume.融資_餘額_股數,
        '限額': StockDaily.f_margin_limit.融資_次日限額_股數
    },
    True
)
...
version_1 = VERSION_1(
    ...
    {
        '代號': StockDaily.f_stock_info.代號,
        '資買': StockDaily.f_margin_flow_volume.融資_買進_股數,
        '資賣': StockDaily.f_margin_flow_volume.融資_賣出_股數,
        '現償': StockDaily.f_margin_flow_volume.融資_現償_股數,
        '資餘額': StockDaily.f_margin_balance_volume.融資_餘額_股數,
        '資限額': StockDaily.f_margin_limit.融資_次日限額_股數
    },
    True
)